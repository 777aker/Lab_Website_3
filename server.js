...
/*create view cgames as select count(*) from football_games where 
...
app.get('/team_stats', function(req, res) {
	...
	var wins = 'select count(*) from (select * from football_games where home_score > visitor_score) as winz;';
	var losses = 'select count(*) from(select * from football_games where visitor_score > home_score) as losz;';
	db.task('get-everything', task => {
	    return task.batch([
	        task.any(games),
	        task.any(wins),
